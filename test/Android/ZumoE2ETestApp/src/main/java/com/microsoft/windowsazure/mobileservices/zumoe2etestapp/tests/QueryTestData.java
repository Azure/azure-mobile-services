...
public class QueryTestData {
    ...
    static {
        ...
        mAllIntIdMovies.add(new IntIdMovie(false, 161, null, getUTCDate(1967, 12, 28), "The Good, the Bad and the Ugly", 1966));
        mAllIntIdMovies.add(new IntIdMovie(false, 96, null, getUTCDate(1957, 3, 31), "12 Angry Men", 1957));
        ...
        mAllIntIdMovies.add(new IntIdMovie(false, 141, null, getUTCDate(1956, 11, 18), "Seven Samurai", 1954));
        ...
        mAllIntIdMovies.add(new IntIdMovie(false, 175, "PG-13", getUTCDate(1968, 12, 20), "Once Upon a Time in the West", 1968));
        ...
        mAllIntIdMovies.add(new IntIdMovie(true, 102, "PG", getUTCDate(1943, 1, 22), "Casablanca", 1942));
        ...
        mAllIntIdMovies.add(new IntIdMovie(false, 109, "TV-14", getUTCDate(1960, 9, 7), "Psycho", 1960));
        ...
        mAllIntIdMovies.add(new IntIdMovie(false, 110, null, getUTCDate(1950, 8, 24), "Sunset Blvd.", 1950));
        ...
        mAllIntIdMovies.add(new IntIdMovie(false, 95, "PG", getUTCDate(1964, 1, 28), "Dr. Strangelove or: How I Learned to Stop Worrying and Love the Bomb",
                1964));
        ...
        mAllIntIdMovies.add(new IntIdMovie(false, 136, null, getUTCDate(1959, 9, 25), "North by Northwest", 1959));
        mAllIntIdMovies.add(new IntIdMovie(false, 87, null, getUTCDate(1931, 3, 6), "City Lights", 1931));
        mAllIntIdMovies.add(new IntIdMovie(false, 125, "PG", getUTCDate(2001, 7, 20), "Spirited Away", 2001));
        mAllIntIdMovies.add(new IntIdMovie(false, 119, "PG", getUTCDate(1941, 9, 4), "Citizen Kane", 1941));
        mAllIntIdMovies.add(new IntIdMovie(false, 87, null, getUTCDate(1936, 2, 24), "Modern Times", 1936));
        mAllIntIdMovies.add(new IntIdMovie(false, 142, "R", getUTCDate(1980, 5, 23), "The Shining", 1980));
        mAllIntIdMovies.add(new IntIdMovie(false, 129, null, getUTCDate(1958, 7, 20), "Vertigo", 1958));
        ...
        mAllIntIdMovies.add(new IntIdMovie(false, 88, null, getUTCDate(1957, 10, 24), "Paths of Glory", 1957));
        mAllIntIdMovies.add(new IntIdMovie(false, 118, "PG-13", getUTCDate(1999, 2, 12), "Life Is Beautiful", 1997));
        mAllIntIdMovies.add(new IntIdMovie(false, 107, null, getUTCDate(1944, 4, 23), "Double Indemnity", 1944));
        ...
        mAllIntIdMovies.add(new IntIdMovie(true, 227, null, getUTCDate(1963, 1, 29), "Lawrence of Arabia", 1962));
        mAllIntIdMovies.add(new IntIdMovie(false, 129, null, getUTCDate(1963, 3, 15), "To Kill a Mockingbird", 1962));
        mAllIntIdMovies.add(new IntIdMovie(false, 130, "PG-13", getUTCDate(2006, 10, 20), "The Prestige", 2006));
        mAllIntIdMovies.add(new IntIdMovie(false, 125, null, getUTCDate(1941, 3, 6), "The Great Dictator", 1940));
        ...
        mAllIntIdMovies.add(new IntIdMovie(false, 93, null, getUTCDate(1949, 8, 30), "The Third Man", 1949));
        mAllIntIdMovies.add(new IntIdMovie(false, 126, null, getUTCDate(1948, 1, 23), "The Treasure of the Sierra Madre", 1948));
        ...
        mAllIntIdMovies.add(new IntIdMovie(false, 103, null, getUTCDate(1952, 4, 10), "Singin' in the Rain", 1952));
        mAllIntIdMovies.add(new IntIdMovie(false, 120, "R", getUTCDate(2003, 11, 21), "Oldboy", 2003));
        mAllIntIdMovies.add(new IntIdMovie(false, 120, null, getUTCDate(1959, 3, 28), "Some Like It Hot", 1959));
        mAllIntIdMovies.add(new IntIdMovie(true, 160, "PG", getUTCDate(1984, 9, 19), "Amadeus", 1984));
        mAllIntIdMovies.add(new IntIdMovie(false, 114, null, getUTCDate(1927, 3, 12), "Metropolis", 1927));
        mAllIntIdMovies.add(new IntIdMovie(false, 88, null, getUTCDate(1951, 12, 25), "Rashomon", 1950));
        mAllIntIdMovies.add(new IntIdMovie(false, 93, null, getUTCDate(1949, 12, 12), "Bicycle Thieves", 1948));
        mAllIntIdMovies.add(new IntIdMovie(false, 141, null, getUTCDate(1968, 4, 5), "2001: A Space Odyssey", 1968));
        mAllIntIdMovies.add(new IntIdMovie(true, 131, "R", getUTCDate(1992, 8, 7), "Unforgiven", 1992));
        mAllIntIdMovies.add(new IntIdMovie(true, 138, null, getUTCDate(1951, 1, 14), "All About Eve", 1950));
        mAllIntIdMovies.add(new IntIdMovie(true, 125, null, getUTCDate(1960, 9, 15), "The Apartment", 1960));
        ...
        mAllIntIdMovies.add(new IntIdMovie(true, 161, null, getUTCDate(1957, 12, 13), "The Bridge on the River Kwai", 1957));
        mAllIntIdMovies.add(new IntIdMovie(false, 131, "R", getUTCDate(1988, 7, 15), "Die Hard", 1988));
        mAllIntIdMovies.add(new IntIdMovie(false, 116, null, getUTCDate(1958, 2, 5), "Witness for the Prosecution", 1957));
        ...
        mAllIntIdMovies.add(new IntIdMovie(false, 129, null, getUTCDate(1939, 10, 18), "Mr. Smith Goes to Washington", 1939));
        mAllIntIdMovies.add(new IntIdMovie(false, 75, "TV-MA", getUTCDate(1961, 9, 12), "Yojimbo", 1961));
        mAllIntIdMovies.add(new IntIdMovie(false, 172, null, getUTCDate(1963, 7, 3), "The Great Escape", 1963));
        mAllIntIdMovies.add(new IntIdMovie(false, 132, "R", getUTCDate(1967, 5, 9), "For a Few Dollars More", 1965));
        ...
        mAllIntIdMovies.add(new IntIdMovie(true, 108, null, getUTCDate(1954, 6, 23), "On the Waterfront", 1954));
        mAllIntIdMovies.add(new IntIdMovie(false, 124, "PG", getUTCDate(1980, 10, 10), "The Elephant Man", 1980));
        mAllIntIdMovies.add(new IntIdMovie(false, 96, null, getUTCDate(1958, 10, 12), "The Seventh Seal", 1957));
        mAllIntIdMovies.add(new IntIdMovie(false, 81, "TV-G", getUTCDate(1995, 11, 22), "Toy Story", 1995));
        mAllIntIdMovies.add(new IntIdMovie(false, 100, null, getUTCDate(1941, 10, 17), "The Maltese Falcon", 1941));
        mAllIntIdMovies.add(new IntIdMovie(false, 170, "R", getUTCDate(1995, 12, 15), "Heat", 1995));
        mAllIntIdMovies.add(new IntIdMovie(false, 75, null, getUTCDate(1927, 2, 23), "The General", 1926));
        mAllIntIdMovies.add(new IntIdMovie(false, 116, "R", getUTCDate(2009, 1, 9), "Gran Torino", 2008));
        mAllIntIdMovies.add(new IntIdMovie(true, 130, null, getUTCDate(1940, 4, 11), "Rebecca", 1940));
        ...
        mAllIntIdMovies.add(new IntIdMovie(false, 91, null, getUTCDate(1959, 6, 21), "Wild Strawberries", 1957));
        mAllIntIdMovies.add(new IntIdMovie(false, 98, "R", getUTCDate(1996, 4, 5), "Fargo", 1996));
        mAllIntIdMovies.add(new IntIdMovie(false, 68, null, getUTCDate(1921, 2, 5), "The Kid", 1921));
        mAllIntIdMovies.add(new IntIdMovie(false, 170, "R", getUTCDate(1983, 12, 9), "Scarface", 1983));
        mAllIntIdMovies.add(new IntIdMovie(false, 108, "PG-13", getUTCDate(1958, 6, 7), "Touch of Evil", 1958));
        ...
        mAllIntIdMovies.add(new IntIdMovie(false, 126, null, getUTCDate(1967, 10, 31), "Cool Hand Luke", 1967));
        mAllIntIdMovies.add(new IntIdMovie(false, 147, "R", getUTCDate(2005, 4, 1), "Sin City", 2005));
        mAllIntIdMovies.add(new IntIdMovie(false, 72, null, getUTCDate(1924, 12, 31), "The Gold Rush", 1925));
        mAllIntIdMovies.add(new IntIdMovie(false, 101, null, getUTCDate(1951, 6, 29), "Strangers on a Train", 1951));
        mAllIntIdMovies.add(new IntIdMovie(true, 105, null, getUTCDate(1934, 2, 22), "It Happened One Night", 1934));
        ...
        mAllIntIdMovies.add(new IntIdMovie(false, 85, null, getUTCDate(1952, 7, 29), "High Noon", 1952));
        ...
        mAllIntIdMovies.add(new IntIdMovie(false, 110, "PG", getUTCDate(1969, 10, 23), "Butch Cassidy and the Sundance Kid", 1969));
        mAllIntIdMovies.add(new IntIdMovie(false, 101, null, getUTCDate(1939, 8, 24), "The Wizard of Oz", 1939));
        ...
        mAllIntIdMovies.add(new IntIdMovie(false, 101, null, getUTCDate(1946, 9, 5), "Notorious", 1946));
        mAllIntIdMovies.add(new IntIdMovie(false, 129, "R", getUTCDate(2009, 8, 13), "The Secret in Their Eyes", 2009));
        mAllIntIdMovies.add(new IntIdMovie(true, 238, "G", getUTCDate(1940, 1, 16), "Gone with the Wind", 1939));
        ...
        mAllIntIdMovies.add(new IntIdMovie(false, 129, null, getUTCDate(1940, 3, 14), "The Grapes of Wrath", 1940));
        ...
        mAllIntIdMovies.add(new IntIdMovie(false, 114, null, getUTCDate(1946, 8, 30), "The Big Sleep", 1946));
        mAllIntIdMovies.add(new IntIdMovie(false, 105, "PG", getUTCDate(1954, 5, 28), "Dial M for Murder", 1954));
        mAllIntIdMovies.add(new IntIdMovie(true, 212, null, getUTCDate(1960, 3, 29), "Ben-Hur", 1959));
        ...
        mAllIntIdMovies.add(new IntIdMovie(false, 93, null, getUTCDate(1955, 11, 23), "The Night of the Hunter", 1955));
        ...
        mAllIntIdMovies.add(new IntIdMovie(false, 99, null, getUTCDate(1959, 11, 15), "The 400 Blows", 1959));
        mAllIntIdMovies.add(new IntIdMovie(false, 83, null, getUTCDate(1967, 3, 15), "Persona", 1966));
        mAllIntIdMovies.add(new IntIdMovie(false, 106, null, getUTCDate(1967, 12, 21), "The Graduate", 1967));
        mAllIntIdMovies.add(new IntIdMovie(true, 191, "PG", getUTCDate(1983, 2, 25), "Gandhi", 1982));
        mAllIntIdMovies.add(new IntIdMovie(false, 85, null, getUTCDate(1956, 6, 5), "The Killing", 1956));
        ...
        mAllIntIdMovies.add(new IntIdMovie(false, 131, null, getUTCDate(1966, 6, 21), "Who's Afraid of Virginia Woolf?", 1966));
        mAllIntIdMovies.add(new IntIdMovie(false, 108, "PG", getUTCDate(1956, 7, 15), "La Strada", 1954));
        mAllIntIdMovies.add(new IntIdMovie(false, 126, null, getUTCDate(1962, 10, 23), "The Manchurian Candidate", 1962));
        mAllIntIdMovies.add(new IntIdMovie(false, 134, null, getUTCDate(1961, 9, 24), "The Hustler", 1961));
        mAllIntIdMovies.add(new IntIdMovie(true, 135, "PG-13", getUTCDate(2002, 1, 4), "A Beautiful Mind", 2001));
        mAllIntIdMovies.add(new IntIdMovie(false, 145, "R", getUTCDate(1969, 6, 17), "The Wild Bunch", 1969));
        mAllIntIdMovies.add(new IntIdMovie(true, 119, "PG", getUTCDate(1976, 12, 3), "Rocky", 1976));
        mAllIntIdMovies.add(new IntIdMovie(false, 160, "TV-PG", getUTCDate(1959, 8, 31), "Anatomy of a Murder", 1959));
        mAllIntIdMovies.add(new IntIdMovie(false, 120, null, getUTCDate(1953, 8, 9), "Stalag 17", 1953));
        ...
        mAllIntIdMovies.add(new IntIdMovie(false, 80, null, getUTCDate(1948, 8, 27), "Rope", 1948));
        mAllIntIdMovies.add(new IntIdMovie(false, 184, "PG", getUTCDate(1975, 12, 18), "Barry Lyndon", 1975));
        mAllIntIdMovies.add(new IntIdMovie(false, 123, null, getUTCDate(1962, 4, 21), "The Man Who Shot Liberty Valance", 1962));
        ...
        mAllIntIdMovies.add(new IntIdMovie(false, 118, null, getUTCDate(1953, 9, 1), "Roman Holiday", 1953));
        ...
        mAllIntIdMovies.add(new IntIdMovie(false, 99, "R", getUTCDate(1967, 1, 17), "A Fistful of Dollars", 1964));
        mAllIntIdMovies.add(new IntIdMovie(false, 125, "PG", getUTCDate(1951, 11, 30), "A Streetcar Named Desire", 1951));
        ...
        mAllIntIdMovies.add(new IntIdMovie(false, 136, "R", getUTCDate(1968, 6, 11), "Rosemary's Baby", 1968));
        mAllIntIdMovies.add(new IntIdMovie(false, 104, null, getUTCDate(1950, 10, 12), "Harvey", 1950));
        ...
        mAllIntIdMovies.add(new IntIdMovie(true, 133, null, getUTCDate(1930, 8, 23), "All Quiet on the Western Front", 1930));
        ...
        mAllIntIdMovies.add(new IntIdMovie(false, 66, null, getUTCDate(1925, 12, 23), "Battleship Potemkin", 1925));
        mAllIntIdMovies.add(new IntIdMovie(false, 138, "R", getUTCDate(2010, 2, 19), "Shutter Island", 2010));
        mAllIntIdMovies.add(new IntIdMovie(false, 81, null, getUTCDate(1929, 6, 2), "Nosferatu", 1922));
        ...
        mAllIntIdMovies.add(new IntIdMovie(false, 102, null, getUTCDate(1938, 2, 17), "Bringing Up Baby", 1938));
        mAllIntIdMovies.add(new IntIdMovie(false, 108, null, getUTCDate(1943, 1, 14), "Shadow of a Doubt", 1943));
        ...
        mAllIntIdMovies.add(new IntIdMovie(true, 109, null, getUTCDate(1967, 10, 13), "In the Heat of the Night", 1967));
        mAllIntIdMovies.add(new IntIdMovie(false, 170, "PG-13", getUTCDate(2009, 12, 24), "3 Idiots", 2009));
        mAllIntIdMovies.add(new IntIdMovie(false, 118, null, getUTCDate(1944, 9, 22), "Arsenic and Old Lace", 1944));
        mAllIntIdMovies.add(new IntIdMovie(false, 119, null, getUTCDate(1956, 3, 12), "The Searchers", 1956));
        mAllIntIdMovies.add(new IntIdMovie(false, 98, "PG", getUTCDate(2000, 9, 29), "In the Mood for Love", 2000));
        mAllIntIdMovies.add(new IntIdMovie(false, 141, null, getUTCDate(1959, 4, 3), "Rio Bravo", 1959));
    }
