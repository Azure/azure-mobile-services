...
public class ZumoPreferenceActivity extends PreferenceActivity {
	...
	public static class GeneralPreferenceFragment extends PreferenceFragment {
		...
		public void onCreate(Bundle savedInstanceState) {
			...
			// guidelines.
			bindPreferenceSummaryToValue(findPreference(Constants.PREFERENCE_MOBILE_SERVICE_URL));
			bindPreferenceSummaryToValue(findPreference(Constants.PREFERENCE_MOBILE_SERVICE_KEY));
		}
	}
}
