...
namespace Microsoft.WindowsAzure.MobileServices.Test.Unit.Table.Sync.Queue.Actions
{
    ...
    public class PullActionTests
    {
        ...
        public async Task DoesNotUpsertAnObject_IfItDoesNotHaveAnId()
        {
            ...
            var action = new PullAction(this.table.Object, this.context.Object, null, query, null, null, this.opQueue.Object, this.settings.Object, this.store.Object, MobileServiceRemoteTableOptions.All, CancellationToken.None);
        ...
        {
            var action = new PullAction(this.table.Object, this.context.Object, "latestItems", query, null, null, this.opQueue.Object, this.settings.Object, this.store.Object, MobileServiceRemoteTableOptions.All, CancellationToken.None);
