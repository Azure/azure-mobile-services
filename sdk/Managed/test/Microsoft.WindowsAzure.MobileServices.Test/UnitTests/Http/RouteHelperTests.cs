    ...
    public class RouteHelperTests : TestBase
    {
        ...
        public static void GetRoute_ReturnsRouteForSimpleNames()
        {
            ...
            var data = new[]
            {
                ...
                new { Kind = RouteKind.Login, Name = "twitter", Route = "http://contoso.azure-mobile.net/login/twitter" },
                new { Kind = RouteKind.Push, Name = "custom", Route = "http://contoso.azure-mobile.net/push/custom" },
            };
        ...
        public static void GetRoute_ForHttps_ReturnsRouteForSimpleNames()
        {
            ...
            var data = new[]
            {
                ...
                new { Kind = RouteKind.Login, Name = "twitter", Route = "https://contoso.azure-mobile.net/login/twitter" },
                new { Kind = RouteKind.Push, Name = "custom", Route = "https://contoso.azure-mobile.net/push/custom" },
            };
        ...
        public static void GetRoute_ReturnsRouteForUris()
        {
            ...
            var data = new[]
            {
                ...
                new { Kind = RouteKind.Login, Name = "a/b", Route = "http://contoso.azure-mobile.net/login/a/b" },
