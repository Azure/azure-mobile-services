...
namespace Microsoft.WindowsAzure.MobileServices
{
    ...
    internal class MobileServiceTableQueryDescription
    {
        ...
        /// </summary>
        public MobileServiceTableQueryDescription()
        {
        ...
        /// the query.
        /// </summary>
        public Delegate Projection { get; set; }

        /// <summary>
        /// Gets or sets the type of the argument to the projection (i.e., the
        /// type that should be deserialied).
        /// </summary>
        ...
        /// for queries.
        /// </summary>
        /// <returns>URI fragment representing the query.</returns>
