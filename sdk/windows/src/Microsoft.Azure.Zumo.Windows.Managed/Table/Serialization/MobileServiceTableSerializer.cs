...
namespace Microsoft.WindowsAzure.MobileServices
{
    ...
    public static class MobileServiceTableSerializer
    {
        ...
        public static T Deserialize<T>(IJsonValue value)
        {
        ...
        public static void Deserialize(IJsonValue value, object instance)
        {
        ...
        public static IJsonValue Serialize(object instance)
        {
        ...
        /// </param>
        public static IJsonValue Serialize(object instance, bool ignoreCustomSerialization)
        {
            if (instance == null)
            {
                throw new ArgumentNullException("instance");
