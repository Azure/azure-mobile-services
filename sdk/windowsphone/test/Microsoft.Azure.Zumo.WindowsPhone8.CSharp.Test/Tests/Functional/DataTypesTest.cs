...
namespace Microsoft.Azure.Zumo.WindowsPhone8.CSharp.Test
{
    ...
    public class DataTypes
    {
        ...
        [DataMemberJsonConverter(ConverterType = typeof(UriDataMemberJsonConverter))]
    ...
    public class UriDataMemberJsonConverter : IDataMemberJsonConverter
    {
    ...
    public class DataTypesContext : IDisposable
    {
        ...
        public void ExpectSerializationFailure<T>(Action<DataTypes, T> setter, params T[] values)
        {
            foreach (T value in values)
            {
                ...
                try
                {
                    JToken data = MobileServiceTableSerializer.Serialize(instance);
