...
namespace Microsoft.WindowsAzure.MobileServices
{
    ...
    /// providers.
    /// </remarks>
    internal static class PartialEvaulator
    {
        /// <summary>
        ...
        /// </returns>
        public static Expression PartiallyEvalulate(Expression expression)
        {
            // Find the independent subtrees and then replace them with
            // constant expressions equivalent to the evaluated subtrees.
            HashSet<Expression> independentSubtrees = FindIndependentSubtrees(expression);
        ...
        /// </returns>
        private static Expression EvaluateIndependentSubtrees(Expression expression, HashSet<Expression> subtrees)
        {
