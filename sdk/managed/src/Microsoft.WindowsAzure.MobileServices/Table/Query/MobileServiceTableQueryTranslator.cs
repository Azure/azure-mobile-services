        ...
        private Expression VisitMethodCall(MethodCallExpression expression)
        {
            ...
            switch (name)
            {
                ...
                case "ThenByDescending":
                    ...
                    break;
                case "Skip":
                    this.queryDescription.Skip = this.queryDescription.Skip + GetCountArgument(expression);
                    break;
                case "Take":
                    int count = GetCountArgument(expression);
                    this.queryDescription.Top = this.queryDescription.Top != 0 ? Math.Min(this.queryDescription.Top, count) : count;
                    break;
                default:
