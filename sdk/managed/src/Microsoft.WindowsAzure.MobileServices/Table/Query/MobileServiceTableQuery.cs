...
namespace Microsoft.WindowsAzure.MobileServices
{
    ...
    internal class MobileServiceTableQuery<T> : IMobileServiceTableQuery<T>
    {
        ...
        internal MobileServiceTableQuery(IMobileServiceTable<T> table, 
                                         MobileServiceTableQueryProvider queryProvider = null,
                                         ...
                                         IDictionary<string, string> parameters = null)
        {
            ...
            this.Query = query ?? new T[0].AsQueryable();
            this.QueryProvider = queryProvider ?? new MobileServiceTableQueryProvider();
        }
