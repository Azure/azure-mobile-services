    ...
    public class MobileServiceContractResolver : DefaultContractResolver
    {
        ...
        public virtual JsonProperty ResolveIdProperty(Type type)
        {
            ...
            if (!this.idPropertyCache.TryGetValue(type, out property))
            {
                ...
                {
                    property = objectContract.Properties.Where(p => string.Equals(p.PropertyName, MobileServiceTableUrlBuilder.IdPropertyName)).FirstOrDefault();
                    if (property != null)
                    {
        ...
        protected override JsonProperty CreateProperty(MemberInfo member, MemberSerialization memberSerialization)
        {
            ...
            if (property.PropertyType.IsValueType)
            {
                ...
                // for value types.
                property.MemberConverter = NullHandlingConverter.Singleton;
            }
        ...
        protected override IList<JsonProperty> CreateProperties(Type type, MemberSerialization memberSerialization)
        {
            ...
            if (tableNameCache.ContainsKey(type))
            {
                ...
                idProperty.PropertyName = MobileServiceTableUrlBuilder.IdPropertyName;
        ...
        private class NullHandlingConverter : JsonConverter
        {
            ...
            /// </summary>
            public static NullHandlingConverter Singleton = new NullHandlingConverter();
