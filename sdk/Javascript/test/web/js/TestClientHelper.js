...
// This file provides $getClient, which the test code uses when trying to make requests to the runtime.
...
$getClient = function () {
    return new WindowsAzure.MobileServiceClient(clientUriElem.value, "dummy-app-key");
};
