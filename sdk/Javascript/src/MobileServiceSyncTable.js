...
function MobileServiceSyncTable(tableName, client) {
    ...
    this.insert = function (instance) {
        ...
        return this.getMobileServiceClient().syncContext.insert(this.getTableName(), instance);
    };
    ...
    this.lookup = function (id) {
        ...
        return this.getMobileServiceClient().syncContext.lookup(this.getTableName(), id);
    };
