...
function Push(mobileServicesClient) {
    ...
    Object.defineProperties(this, {
        ...
        'mdn': {
            get: function(){
                if(!this._mdn){
                    var name = _.format("MS-PushContainer-mdn-{0}", mobileServicesClient.applicationUrl);
                    this._registrationManager = new RegistrationManager(mobileServicesClient, 'mdn', name);
                    this._mdn = new mdn(this);
                }
                return this._mdn;
            }
        }
...
mdn.prototype.registerNative = function (deviceId, tags) {
    /// <summary>
    /// Register for native notification
    /// </summary>
    /// <param name="deviceId">
    ...
    return this._push._register('mdn', deviceId, tags);
};

mdn.prototype.registerTemplate = function (deviceId, name, bodyTemplate, tags) {
    /// <summary>
    /// Register for template notification
    /// </summary>
    /// <param name="deviceId">
    ...
    return this._push._registerTemplate('mdn', deviceId, name, bodyTemplate, null, tags);
};

mdn.prototype.unregisterNative = function () {
    /// <summary>
    /// Unregister for native notification
    /// </summary>
    /// <returns>
...
mdn.prototype.unregisterTemplate = function (templateName) {
    /// <summary>
    /// Unregister for template notification
    /// </summary>
    /// <param name="templateName">
...
mdn.prototype.unregisterAll = function (deviceId) {
    /// <summary>
    /// DEBUG-ONLY: Unregisters all registrations for the given device token
    /// </summary>
    /// <param name="deviceId">
