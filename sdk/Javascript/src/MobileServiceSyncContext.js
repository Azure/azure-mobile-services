...
var MobileServiceMemoryStore = require('MobileServiceMemoryStore').MobileServiceMemoryStore;
...
function MobileServiceSyncContext(client) {
    ...
    this.initialize = function (store) {
        ...
        if (store === undefined) {
            this.store = new MobileServiceMemoryStore();
        } else {
            this.store = store;
        }
    };
    ...
    this.insert = function (tableName, instance) {
        ...
        return this.store.insert(tableName, instance).then(function () {
    ...
    this.lookup = function (tableName, id) {
        ...
        return this.store.lookup(tableName, id);
    };
}
