...
abstract class MobileServiceTableBase implements MobileServiceTableSystemPropertiesProvider {
	 ...
	 * 
	 * @param instance
	 *            The instance to remove the system properties from.
	 * @param version
	 *            Set to the value of the version system property before it is
	 *            removed.
	 ...
	 * 
	 * @param value
	 *            The value to create the etag from.
	 * @return The etag.
	 */
	 ...
	 * 
	 * @param etag
	 *            The etag to get the value from.
	 * @return The value.
	 */
	 ...
	 * 
	 * @param properties
	 *            The system properties to set in the system properties header.
	 ...
	 *            The system property to set in the system properties header.
