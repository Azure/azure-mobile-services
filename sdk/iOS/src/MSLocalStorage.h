...
- (void) updateWithRegistrationName: (NSString*) registrationName registrationId:(NSString*) registrationId deviceToken:(NSString*) deviceToken;
- (void) updateWithRegistrationId: (NSString*) registrationId registrationName:(NSString*) registrationName  deviceToken:(NSString*) deviceToken;
